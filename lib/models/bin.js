...
module.exports = Observable.extend({
  ...
  getAssignmentData: function(params, fn) {
    var timer = metrics.createTimer(metric_prefix + 'getAssignmentData');
    this.store.getAssignmentData(params, fn);
  },
  getStudentAssignments: function(params, fn) {
    var time = metrics.createTimer(metric_prefix + 'getStudentAssignments');
    this.store.getStudentAssignments(params, fn);
  },
