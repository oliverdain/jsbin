...
module.exports = Observable.extend({
  ...
  setAssignmentStarted: function(user_name, assignment_id, bin, fn) {
    var timer = metrics.createTimer(metric_prefix + 'setAssignmentStarted');
    var cb = _.partial(fn, user_name, bin);
    this.store.setAssignmentStarted(user_name, assignment_id, bin, cb);
  },
