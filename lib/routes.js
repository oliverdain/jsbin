...
module.exports = function (app) {
  ...
  if (app.settings['class']) {
    app.get('/', binHandler.getStudentHome);
    app.get('/bin', binHandler.getDefault);
  } else {
    app.get('/', binHandler.getDefault);
  }
  app.get('/gist/*', binHandler.getDefault);
  // TODO(NOW) It seems like this is going to cause problems with the student
  // home page.
  app.post('/', binHandler.getFromPost);

  // Assignments
  app.post('/startAssignment', binHandler.startAssignment);
